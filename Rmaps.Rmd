...
First all the site coordinates in degrees and minutes but be converted to decimal.
...
map <- ggmap(get_stadiamap(WLT, zoom = 12, maptype = "stamen_toner_lite")) + 
  ...
  ylab("Latitude (decimal)") +
  xlab("Longitude (decimal)") +
